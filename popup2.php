...
$(document).ready(function(){
	$("tr#tbitem").click(function() {        // function_tr
		...
		window.opener.document.theForm.cost.value=cost; 
		...
		window.opener.document.theForm.code.focus();
		self.close(); 
...
<div class="headerText">Annual Procurement Plan</div>
  <table width="100%" cellspacing="0" cellpadding="0" border="1" class="listpop" id="listpop">
	<tr>
		<th>CODE</th>
		<th>DESCRIPTION</th> 
	</tr>
