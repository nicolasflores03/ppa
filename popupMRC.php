...
$(document).ready(function(){
	$("tr#tbitem").click(function() {        // function_tr
		...
		window.opener.document.theForm.cost_center.value=cost_center;
		
		if( objName == "R5MRCS" ){
		window.opener.document.theForm.MRC_CODE.value=id;
		window.opener.document.theForm.MRC_DESC.value=name;
		}
		self.close(); 
...
<!--Start of FORM-->
<div class="headerText">Department List</div>
