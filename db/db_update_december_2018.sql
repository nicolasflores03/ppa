...
ALTER TABLE dbo.R5_REF_ITEMBASE_BUDGET_MONTH ALTER COLUMN january numeric(24,6);
ALTER TABLE dbo.R5_REF_ITEMBASE_BUDGET_MONTH ALTER COLUMN february numeric(24,6);
ALTER TABLE dbo.R5_REF_ITEMBASE_BUDGET_MONTH ALTER COLUMN march numeric(24,6);
ALTER TABLE dbo.R5_REF_ITEMBASE_BUDGET_MONTH ALTER COLUMN april numeric(24,6);
ALTER TABLE dbo.R5_REF_ITEMBASE_BUDGET_MONTH ALTER COLUMN may numeric(24,6);
ALTER TABLE dbo.R5_REF_ITEMBASE_BUDGET_MONTH ALTER COLUMN june numeric(24,6);
ALTER TABLE dbo.R5_REF_ITEMBASE_BUDGET_MONTH ALTER COLUMN july numeric(24,6);
ALTER TABLE dbo.R5_REF_ITEMBASE_BUDGET_MONTH ALTER COLUMN august numeric(24,6);
ALTER TABLE dbo.R5_REF_ITEMBASE_BUDGET_MONTH ALTER COLUMN september numeric(24,6);
ALTER TABLE dbo.R5_REF_ITEMBASE_BUDGET_MONTH ALTER COLUMN october numeric(24,6);
ALTER TABLE dbo.R5_REF_ITEMBASE_BUDGET_MONTH ALTER COLUMN november numeric(24,6);
ALTER TABLE dbo.R5_REF_ITEMBASE_BUDGET_MONTH ALTER COLUMN december numeric(24,6);
					  
ALTER TABLE dbo.R5_EAM_DPP_ITEMBASE_LINES ALTER COLUMN quantity numeric(24,6); 
