...
$requiredField2 = array('created_date','Source_Department','Source','source_quarter','Destination_Organization','Destination_Department','Destination','destination_quarter','amount','year_budget','type','status','reason');
